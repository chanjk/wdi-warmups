...
> 1. Ask any guard "Which path will the other guard say leads to paradise?"  
> 2. Then, take the _OTHER_ path (e.g. if the guard says left, go right instead).
...
> The son of the man looking at the picture.
...
> 2. Go back and carry the corn across.
> 3. Carry the chicken back to the other side.
> 4. Leave the chicken on the other side and carry the fox across.
> 5. Go back and carry the chicken across.
